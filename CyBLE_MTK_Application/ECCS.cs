...
//      9100			Shopfloor Process Check fail
                        //MESProcessCheck:Barcode Invalid Error(9100)
                        //MESProcessCheck:Incorrect Process Station(9101)
                        //MESProcessCheck:MES STOP(9102)
                        //MESProcessCheck:MES LOCK(9103)
...
//      FFFF            Others
    ...
    class ECCS
    {
        ...
        public const UInt16 ERRORCODE_CyBLE_GetRSSI_TEST_FAIL = 0x0310;
        ...
        public const UInt16 ERRORCODE_MES_PROCESS_ConnectionLoss = 0x404;
        public const UInt16 ERRORCODE_MES_PROCESS_BarcodeInvalidError = 0x9100;
        public const UInt16 ERRORCODE_MES_PROCESS_IncorrectProcessStation = 0x9101;
        public const UInt16 ERRORCODE_MES_PROCESS_MESSTOP = 0x9102;
        public const UInt16 ERRORCODE_MES_PROCESS_MESLOCK = 0x9103;
